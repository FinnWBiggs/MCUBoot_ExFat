...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_MSC_STORAGE_NONE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DISK_RAM_VOLUME_SIZE, 32);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MASS_STORAGE_DISK_NAME, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MAIN_STACK_SIZE, 2800);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DISK_RAM_VOLUME_NAME, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DRIVER_LOG_LEVEL_ERR, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DRIVER_LOG_LEVEL, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DEVICE_PID, 0x0008);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_MASS_STORAGE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MASS_STORAGE_INQ_VENDOR_ID, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MASS_STORAGE_INQ_PRODUCT_ID, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MASS_STORAGE_INQ_REVISION, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MASS_STORAGE_BULK_EP_MPS, 64);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MASS_STORAGE_STACK_SIZE, 512);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_MASS_STORAGE_LOG_LEVEL_ERR, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_MASS_STORAGE_LOG_LEVEL, 1);
